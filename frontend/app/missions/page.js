...
export const metadata = { title: 'Missions, coming soon · yo-yo' };
...
const PREVIEW = [
  ...
  { emoji: '📈', title: 'Dividend collector', body: 'Receive a stock dividend from any yo-yo token. (later)' },
];
      ...
      <main className="mx-auto max-w-3xl px-5 py-8">
        <div className="mb-6">
          ...
          <p className="mt-3 max-w-xl text-sm leading-relaxed text-mut">
            ...
            ETH rewards straight to your wallet, gasless. And soon, every project on yo-yo will be able to run missions for
            their own holders.
          </p>
        </div>
