  ...
  if (!wallet.connected) {
    return (
      <div className="panel mx-auto max-w-md px-6 py-10 text-center">
        ...
        <p className="mt-2 text-sm text-mut">Connect your Robinhood Chain wallet to see the Yoyo tokens you hold and vote on their next dividend. Voting is gasless: you only sign a message.</p>
  ...
  if (eligible.length === 0) {
    return (
      <div className="panel px-6 py-12 text-center">
        ...
        <p className="mt-1 text-xs text-mut">You don't hold any token with an active Community Vote (at the last snapshot). Hold a vote-enabled Yoyo token to take part.</p>
