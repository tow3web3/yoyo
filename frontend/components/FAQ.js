...
const ITEMS = [
  { q: 'What is a Robinhood Stock Token?', a: 'A token on Robinhood Chain that tracks a real stock or ETF: NVDA, TSLA, SPY, GLD and 191 more. They are plain ERC-20s, so 0xdiv can buy them on Uniswap and send them to your holders like any other token.' },
  ...
  { q: 'Where do my fees come from?', a: 'Launchpads on Robinhood Chain pay creators in stock tokens and/or ETH, straight to the dev wallet. Every cycle 0xdiv sweeps that wallet: all 195 Robinhood Stock Tokens and ETH above a small gas reserve. If your token trades on Uniswap V3 with a position you hold, it also collects the LP fees.' },
  { q: 'Do my holders get the same stock the launchpad paid me?', a: 'Yes, by default. Stock fees are paid through in kind: NVDA in, NVDA out, pro-rata, no swap and no slippage. Switch to convert mode if you would rather pay a single stock of your choice; ETH fees are always converted to the stock you picked, with the fair-price guard.' },
  ...
  { q: 'Can I keep part of the fees?', a: 'Yes: that is the payout ratio. Presets from 100% to holders down to 50%, with the rest going to your payout address, a buyback and burn, or the treasury, in any mix. Everything is published on the dashboard so holders know the policy.' },
  { q: 'What is the treasury?', a: 'Retained earnings. A share of each cycle goes to a wallet you control: stock fees move there in kind, ETH fees buy a stock (SPY by default). The dashboard shows the balance sheet, book value per token, and what share of the market cap the treasury backs.' },
