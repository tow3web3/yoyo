...
const SCENES = [
  { key: 'loop', label: 'The loop', title: 'Fees in, dividends out', body: 'Your launchpad pays the dev wallet in stocks. Every cycle Boomerang applies the policy: holders, you, buyback, treasury.' },
