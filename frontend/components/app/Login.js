    ...
    <div className="mx-auto grid max-w-5xl items-center gap-10 px-5 py-16 lg:grid-cols-[1.1fr_0.9fr]">
      <div>
        ...
        <ul className="mt-6 space-y-2 text-sm text-mut">
          {['Sign in with any wallet, no gas, no email', 'yo-yo creates a dedicated dev wallet for you, or import yours', 'Link Telegram later for receipts and alerts'].map((t) => (
