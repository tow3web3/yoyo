...
const ITEMS = [
  ...
  { q: 'Where do my fees come from?', a: 'Launchpads on Robinhood Chain pay creators in stock tokens and/or ETH, straight to the dev wallet. Every cycle Boomerang sweeps that wallet: all 195 Robinhood Stock Tokens and ETH above a small gas reserve. If your token trades on Uniswap V3 with a position you hold, it also collects the LP fees.' },
