    ...
    <footer className="border-t border-line bg-ground px-5 py-8">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-5 md:flex-row">
        ...
        <div className="flex flex-wrap items-center justify-center gap-5 text-sm text-mut">
          ...
          <a href="https://github.com/tow3web3/boomerang" target="_blank" rel="noopener noreferrer" aria-label="Boomerang on GitHub" className="flex items-center transition hover:text-ink"><Github className="h-4 w-4" /></a>
          ...
          <span className="text-xs text-mut/70">Not affiliated with Robinhood Markets. Stock Tokens are issued by Robinhood; Boomerang only routes them.</span>
        </div>
      </div>
    </footer>
  );
