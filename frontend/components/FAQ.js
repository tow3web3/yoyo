...
const ITEMS = [
  { q: 'What is a Robinhood Stock Token?', a: 'A token on Robinhood Chain that tracks a real stock or ETF: NVDA, TSLA, SPY, GLD and 191 more. They are plain ERC-20s, so yo-yo can buy them on Uniswap and send them to your holders like any other token.' },
  ...
  { q: 'Where do my fees come from?', a: 'Launchpads on Robinhood Chain pay creators in stock tokens and/or ETH, straight to the dev wallet. Every cycle yo-yo sweeps that wallet: all 195 Robinhood Stock Tokens and ETH above a small gas reserve. If your token trades on Uniswap V3 with a position you hold, it also collects the LP fees.' },
