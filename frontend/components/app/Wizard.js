...
// Setup: pick the wallet first (the connected one, or a key you import), yo-yo
      ...
      <div className="panel p-6">
        {step === 0 && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-mut">yo-yo scans Robinhood Chain for the tokens this wallet created, so you can pick yours in one tap.</p>
            <div className="grid gap-3 sm:grid-cols-2">
              <button type="button" onClick={() => setWallet({ ...wallet, mode: 'mine' })} className={`rounded-xl border p-4 text-left transition ${wallet.mode === 'mine' ? 'border-hood-500 bg-hood-50' : 'border-line hover:border-hood-300'}`}>
                ...
                <div className="mt-1 text-xs text-mut">We list the tokens it created. yo-yo then creates a dedicated dev wallet for the fees (a bot cannot sign with your browser wallet); you set it as fee recipient on your launchpad.</div>
              </button>
