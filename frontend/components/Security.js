  ...
  return (
    <div className="grid items-start gap-8 lg:grid-cols-[0.8fr_1.2fr]">
      <div>
        ...
        <p className="mt-3 text-sm leading-relaxed text-mut">yo-yo handles a wallet key to automate on-chain actions, so it is designed around least privilege, encryption, a price guard, and full owner control.</p>
      </div>
