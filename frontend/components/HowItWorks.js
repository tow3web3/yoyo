...
const STEPS = [
  { n: '01', Icon: Coins, title: 'Sweep the fees', body: 'Your launchpad pays you in stock tokens (or ETH). Every cycle 0xdiv sweeps the dev wallet: all 195 Robinhood Stock Tokens and ETH above a small gas reserve.', tile: 'bg-hood-100 text-hood-700', ring: 'hover:border-hood-300' },
