...
const ITEMS = [
  { q: 'What is a Robinhood Stock Token?', a: 'A token on Robinhood Chain that tracks a real stock or ETF: NVDA, TSLA, SPY, GLD and 191 more. They are plain ERC-20s, so Yoyo can buy them on Uniswap and send them to your holders like any other token.' },
