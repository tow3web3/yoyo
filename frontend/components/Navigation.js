      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="flex h-14 items-center justify-between gap-4">
          <Link href="/" className="group flex items-center gap-2.5">
            ...
            <span className="hidden items-center gap-1.5 whitespace-nowrap rounded-full border border-hood-200 bg-hood-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-hood-700 sm:inline-flex">
